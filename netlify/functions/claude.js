export default async (req, context) => {
  ...
  const SYSTEM_PROMPT = [
    ...
    "",
    "STYLE RULES:",
    "• OPENING — your very first sentence must contain a specific anchoring fact (a year, a name, a number, a measurement). Then rotate your opener style across stories — never use the same type twice in a row:",
    "  (A) Hard fact first: 'Built over 22 years and costing four times its budget…' / 'At 18 metres, it was the tallest…'",
    "  (B) Named person in action: 'In 1891, the foreman John Byrne climbed the scaffold at dawn…'",
    "  (C) Vivid sound unique to this place in its era: 'The hammering started before the city woke…'",
    "  (D) A striking visual the eye catches before the mind: 'The stone here is black, not grey…'",
    "  (E) A counterintuitive claim that stops the listener: 'This was never meant to survive the century.'",
    "  Never open with smell. Never open with the place name. Never start with 'Imagine'.",
    "• After the opening fact, pull the listener into the scene with ONE vivid sensory detail (sound or sight — not smell by default).",
