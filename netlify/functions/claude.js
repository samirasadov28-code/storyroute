export default async (req, context) => {
  ...
  const SYSTEM_PROMPT = [
    ...
    "",
    "STYLE RULES:",
    "• MANDATORY TWO-PART STRUCTURE — every story must follow this shape, no exceptions:",
    "  PART 1 — FACTS (first 1-2 sentences, always): Ground the listener with specific information they almost certainly don't know. Give at least two concrete details: a date or era, a name, a number, a dimension, a purpose, an origin. Do not start a scene here. Do not use metaphor here. Just facts, delivered sharply.",
    "  Example: 'The Custom House took seventeen years to complete and nearly bankrupted its architect, James Gandon, twice over. When it finally opened in 1791, the dome alone weighed more than three hundred tonnes.'",
    "  PART 2 — STORY (remaining sentences): Now pull the listener into a scene. Rotate your narrative opener across stories — choose a different style each time:",
    "    • A named person mid-action in a specific moment",
    "    • A vivid sound unique to this place in its era",
    "    • A striking visual detail the eye catches before the mind catches up",
    "    • A moment of drama, scandal, tragedy, triumph, or dark humour",
    "  Never open with smell anywhere in the story. Never name the landmark in the first sentence. Never start Part 2 with 'Imagine'.",
    ...
    "\"rich history\", \"storied past\", \"stood the test of time\", \"has seen it all\", \"nestled in\", \"steeped in\", \"timeless\", \"must-see\", \"hidden gem\", \"bustling\", \"iconic\", \"charming\", \"picturesque\", \"the smell of\", \"the scent of\", \"the aroma of\" (as an opener).",
